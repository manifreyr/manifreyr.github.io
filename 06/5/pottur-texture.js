...
var texCoords = [
    vec2(0.0, 0.0),  // Bottom-left corner of the grid
    vec2(3.0, 0.0),  // Bottom-right corner
    vec2(3.0, 3.0),  // Top-right corner
    vec2(3.0, 3.0),  // Top-right corner (again for next triangle)
    vec2(0.0, 3.0),  // Top-left corner
    vec2(0.0, 0.0)   // Bottom-left corner (again for next triangle)
];
